...
setCartItems(cart.IncrementReducer)
  ...
  return (
    <div className="min-h-screen bg-linear-to-br from-slate-50 via-amber-50/30 to-slate-100 mt-10">
      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div className="mb-12">
          <div className="flex items-center gap-3 mb-3">
            ...
            <h1 className="text-5xl font-light text-slate-900 tracking-tight">Shopping Cart</h1>
          </div>
        ...
        <div className="grid lg:grid-cols-3 gap-8">
          ...
          <div className="lg:col-span-2 space-y-4">
            {cartItems.length === 0 ? (
              <div className="bg-white/70 backdrop-blur-sm rounded-2xl shadow-sm border border-slate-200/50 p-16 text-center">
              ...
              cartItems.map((item, index) => (
                <div
                  key={item.id}
                  className="bg-white/70 backdrop-blur-sm rounded-2xl shadow-sm border border-slate-200/50 p-6 hover:shadow-md transition-all duration-300 group"
                  style={{ animationDelay: `${index * 100}ms` }}
                >
                  <div className="flex gap-6">
                    {/* Product Image */}
                    <div className="relative shrink-0">
                      <div className="w-32 h-32 rounded-xl overflow-hidden bg-linear-to-br from-slate-100 to-slate-50 border border-slate-200/50">
                        <img
                          src={item.pic_url}
                          alt={item.name}
                    ...
                    <div className="flex-1 min-w-0">
                      <div className="flex justify-between items-start mb-2">
                        <div>
                          ...
                          <h3 className="text-xl font-medium text-slate-900 mb-1">{item.name}</h3>
              ...
              <div className="bg-white/70 backdrop-blur-sm rounded-2xl shadow-lg border border-slate-200/50 p-6">
                ...
                <div className="mb-6">
                  ...
                  <div className="flex gap-2">
                    <input
                      ...
                      className="flex-1 px-4 py-2.5 bg-slate-50 border border-slate-200 rounded-xl text-slate-900 placeholder-slate-400 focus:outline-none focus:ring-2 focus:ring-amber-500/50 focus:border-amber-500 transition-all"
                    />
                    <button
                      onClick={applyPromo}
                ...
                <div className="mt-6 pt-6 border-t border-slate-200">
                  ...
                  <div className="flex justify-center gap-3 opacity-60">
                    <div className="w-10 h-7 bg-slate-200 rounded flex items-center justify-center text-xs font-bold text-slate-600">
                      VISA
                    </div>
                    <div className="w-10 h-7 bg-slate-200 rounded flex items-center justify-center text-xs font-bold text-slate-600">
                      MC
              ...
              <div className="mt-4 bg-slate-900/5 backdrop-blur-sm rounded-2xl border border-slate-200/50 p-5 space-y-3">
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-xs text-slate-600 font-light">30-day return policy</p>
                  </div>
                </div>
                <div className="flex items-start gap-3">
                  <div className="w-8 h-8 rounded-full bg-amber-500/20 flex items-center justify-center flex-shrink-0">
                  ...
                  <div>
                    <p className="text-sm font-medium text-slate-900">Warranty Included</p>
                    <p className="text-xs text-slate-600 font-light">1-year manufacturer warranty</p>
                  </div>
                </div>
              </div>
            </div>
